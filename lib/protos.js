 ...
 * loading.
 * @param {Boolean} shouldMoveIframeToBody to specify whether to load the iframe in head or body
 */

exports.load = function(name, locals, callback, shouldMoveIframeToBody = false) {
  // Argument shuffling
  ...
  case 'script':
    ...
    break;
  case 'iframe':
    el = loadIframe(attrs, callback, shouldMoveIframeToBody);
    break;
  default:
      // No default case
  }
