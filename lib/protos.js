 ...
 * loading.
 * @param {Boolean} moveToBody to specify whether to load the iframe in head or body
 */

exports.load = function(name, locals, callback, moveToBody) {
  // Argument shuffling
  ...
  case 'script':
    ...
    break;
  case 'iframe':
    el = loadIframe(attrs,callback,moveToBody);
    break;
  default:
      // No default case
  }
